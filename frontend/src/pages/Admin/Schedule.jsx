...
const Schedule = () => {
  ...
  const handleAddPeriod = async (e) => {
    e.preventDefault();
    const { classNumber, day, period, subject, teacher, teacherEmail, time } = formData;
  
    if (!classNumber || !day || !period || !subject || !teacher || !teacherEmail || !time) {
      Swal.fire({
        icon: "error",
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFormData({
                    ...
                    teacherEmail: selectedTeacher.email, // ✅ Email store করলাম
                  });
                }}
                className="select select-bordered w-full"
              >
